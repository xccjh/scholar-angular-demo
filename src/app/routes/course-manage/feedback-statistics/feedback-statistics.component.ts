...
@Component({
  ...
  styleUrls: ['./feedback-statistics.component.less'],
})
export class FeedbackStatisticsComponent extends SearchTableComponent {
  _PAGE_ID_ = 'FeedbackStatisticsComponent';
  historys = [];
